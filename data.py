...
def mnist():
    def concat_npz(path):
        ...
        np.savez_compressed(
            r"/Users/alejandranavarrocastillo/Documents/GitHub/dtu_mlops_s1_final_exercise/data/corruptmnist/train.npz",
    ...
    concat_npz(
        r"/Users/alejandranavarrocastillo/Documents/GitHub/dtu_mlops_s1_final_exercise/data/corruptmnist"
    )
    data_train = np.load(
        r"/Users/alejandranavarrocastillo/Documents/GitHub/dtu_mlops_s1_final_exercise/data/corruptmnist/train.npz"
    )
    data_test = np.load(
        r"/Users/alejandranavarrocastillo/Documents/GitHub/dtu_mlops_s1_final_exercise/data/corruptmnist/test.npz"
    )
